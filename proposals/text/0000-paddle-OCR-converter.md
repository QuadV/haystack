- Title: Add PaddleOCR converter node for additional OCR PDF conversion support
- Decision driver: (your name here)
- Start Date: 2023-02-08
- Proposal PR: n/a
- Github Issue or Discussion: (#3993)[https://github.com/deepset-ai/haystack/issues/3993]

# Summary

PaddleOCR aims to create multilingual, awesome, leading, and practical OCR tools that help users train better models and apply them into practice. 
This could be used as a good alternative to the AzureConverter and the current PDFToTextOCRConverter in Haystack, since PaddleOCR seems to have good layout and table detection.
